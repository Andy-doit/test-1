...
export default function TikTokFloatingButton() {
  const tiktokUrl = "https://www.tiktok.com/@hotstockvn.com?_r=1&_t=ZS-918pEt3aj0k";

  return (
    <div className="fixed bottom-6 right-24 z-[60] pointer-events-none select-none">
      {/* subtle pulse halo */}
